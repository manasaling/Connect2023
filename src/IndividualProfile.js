            ...
            <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"></link>
                    ...
                    <div className="w3-third">
                        ...
                        <div className="w3-container">
                            ...
                            <p>Healthcare</p>
                            <div className="w3-light-grey w3-round-xlarge w3-small">
                            <div className="w3-container w3-center w3-round-xlarge connect-purple">80%</div>
                            </div>
                            <p>Education</p>
                            <div className="w3-light-grey w3-round-xlarge w3-small">
                            <div className="w3-container w3-center w3-round-xlarge connect-purple">50%</div>
                            </div>
                            <p>Justice</p>
                            <div className="w3-light-grey w3-round-xlarge w3-small">
                            <div className="w3-container w3-center w3-round-xlarge connect-purple">40%</div>
                            </div>
                        </div>
                        </div>
                    </div>
                    ...
                    <div className="w3-twothird">
                        ...
                        <div className="w3-container">
                            <h3 className="w3-opacity w3-text-black"><b>Front End Developer / w3schools.com</b></h3>
                        ...
                        <div className="w3-container">
                            <h3 className="w3-opacity w3-text-black" ><b>Web Developer / something.com</b></h3>
                        ...
                        <div className="w3-container">
                            <h3 className="w3-opacity w3-text-black"><b>Graphic Designer / designsomething.com</b></h3>
